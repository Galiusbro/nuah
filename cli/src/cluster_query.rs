    ...
    fn cluster_query_subcommands(self) -> Self {
        ...
        .subcommand(
            SubCommand::with_name("supply")
                .about("Get information about the cluster supply of NUAH")
                .arg(
        ...
        .subcommand(
            SubCommand::with_name("total-supply")
                .about("Get total number of NUAH")
            ...
            SubCommand::with_name("rent")
                ...
                .arg(
                    Arg::with_name("lamports")
                        .long("lamports")
                        .takes_value(false)
                        .help("Display rent in lamports instead of NUAH"),
                ),
        )
    }
}
...
pub fn process_total_supply(rpc_client: &RpcClient, _config: &CliConfig) -> ProcessResult {
    ...
    Ok(format!("{} NUAH", lamports_to_sol(supply.total)))
}
